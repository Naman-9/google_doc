    ...
    const handleMouseMove = (e: React.MouseEvent) => {
        ...
        if((isDraggingLeft || isDraggingRight) && rulerRef.current){
            ...
            if(container) {
                ...
                if(isDraggingLeft){
                  const maxLeftPosition = PAGE_WIDTH - (rightMargin - MINIUM_SPACE);
                  const newLeftPosition = Math.min(rawPosition, maxLeftPosition);
                  setLeftMargin(newLeftPosition);  // TODO: Make it collabrative

                } else if (isDraggingRight) {
                  const maxRightPosition = PAGE_WIDTH - (leftMargin +  MINIUM_SPACE);
